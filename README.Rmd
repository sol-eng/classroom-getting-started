...
Also, make a note of the RStudio Connect URL link, because you'll need to in step 7.  To get the link, right click on the "RStudio Connect" button and copy the URL.
...
To publish shiny apps, R markdown report and `plumber` APIs to RStudio Connect, you must first connect your RStudio Server Pro instance to your user acccount on RStudio Connect.

To do this:

* In RStudio Server Pro, sse the menu item `Tools --> Global Options --> Publishing`
...
* This will start a process of validating your account agains RStudio Connect.
...
* If you entered the correct credentials, you will land back in RStudio Server Pro, where the window should say "Account verified"

<img src="inst/images/rsp-connect-verified.png" width="400px" />

* Click "Connect account". This will take you back to the RStudio Server Pro options screen, where your connected account should show up in the list of "Publishing account".
...
To test that everything worked, create and publish a Shiny app to Connect:

* In the RStudio Server Pro menu, click `File --> New file --> Shiny Web App...`

* Give the file a name, e.g. `test`

* Run the shiny app, to prove to yourself it works locally

* Click the publish button <img src="inst/images/publish-button.png"/> (next to the "Run Shiny App" button)

<img src="inst/images/rsc-publish.png" width="400px" />

* Give the app a title and press Publish

* This starts the upload of a "bundle" with your app code and package dependencies.

* Upon successful completion, your newly deployed app will open in RStudio Connect
